...
<section class="fdb-block py-0">
    <div class="row p-5">
        <div class="col-12 col-sm-10 col-md-8 m-md-auto ps-lg-5 col-lg-6 text-left order-2 order-lg-1">
            <h1 class="display-4">
                <strong><?php echo wp_kses_post($welcome_title); ?></strong>
            </h1>
            <p class="lead">
    ...
    <div class="container py-5 my-5 justify-content-center align-items-center d-flex">
        <div class="row justify-content-center text-center">
            <div class="col-12 col-md-8 bg-glass-light rounded-5">
                ...
                <p class="mt-5">
                    <a href="<?php echo home_url();?>/quote" class="btn btn-lg btn-dark">Quote a Design</a>
                </p>
            </div>
        </div>
    </div>
...
<section class="bg-white text-dark fdb-blog fdb-viewport py-5">
    ...
    <div class="row text-left mt-5">
        ...
        <?php if ($query->have_posts()) : $count = 0; ?>
            <?php while ($query->have_posts()) : $query->the_post(); $count++; ?>
                <div class="col-12 col-sm-8 col-md-4 col-lg-3 mx-auto mb-5 pt-0">
                    <div class="row">
    ...
    <p class="text-center mt-4">
        <a href="https://www.froala.com" class="btn btn-lg btn-primary rounded-pill">View All Posts</a>
    </p>
</section>
    ...
    <div class="container">
        <div class="row align-items-center text-left">
            ...
            <div class="col-12 col-md-3 ml-auto text-left text-md-right">
                <p class="text-center">
                    <a href="https://www.froala.com" class="btn btn-lg btn-primary">Subscribe</a>
                </p>
            </div>
        </div>
    </div>
